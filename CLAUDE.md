...
- Voice call (iPhone): on-device speech in, bot's final replies read aloud; the host sees plain messages. Pro cloud-realtime plan: [docs/voice-call.md](docs/voice-call.md).
