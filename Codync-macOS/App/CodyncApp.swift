...
private let logger = Logger(subsystem: "com.pokai.Codync", category: "App")
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        scanner.start()
        logger.info("Codync launched — hook-driven status detection (7 hooks) + JSONL supplementary data")
